...
public partial class SplashWindow : SplashWindowBase
{
    ...
    public string SplashCustomLogoSource =>
        ImportedFileReference.Resolve(SettingsService.Settings.SplashCustomLogoSource);

    public bool UseDefaultSplashLogo =>
        string.IsNullOrWhiteSpace(SettingsService.Settings.SplashCustomLogoSource);
